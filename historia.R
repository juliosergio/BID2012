...
# SCRIPT
# -----------
rm(list=ls()) # comando para limpar a memÃ³ria do R
#---------------------------------------­----------------------------------
# Entrada de dados
#---------------------------------------­----------------------------------
...
attach(ex1) # anexando os dados na memÃ³ria do R
names(ex1)
dim(ex1)
#---------------------------------------­-------------------
# GrÃ¡fico com as 3 variÃ¡veis em estudo em 2D
#---------------------------------------­-------------------
...
#---------------------------------------­-------------------
# GrÃ¡fico com as 3 variÃ¡veis em estudo em 3D
#---------------------------------------­-------------------
require(Rcmdr)
...
bdir <- "CUENCAS"
cuencas <- list.files(bdir) # orden alfabÃ©tico, para el caso es suficiente
cc <- cuencas[1]
cc
cdir <- paste0(bdir, "/", cc)
# Archivo con la definiciÃ³n de las estaciones
fname <- paste0(cdir, "/Estaciones.txt")
# Las estaciones:
ee <- read.table(fname, header=T)
# GeometrÃ­a de la cuenca:
